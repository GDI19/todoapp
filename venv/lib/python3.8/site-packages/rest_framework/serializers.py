...
# Note: We do the following so that usersapp of the framework can use this style:
#
...
class Serializer(BaseSerializer, metaclass=SerializerMetaclass):
    ...
    def get_fields(self):
        ...
        # This allows usersapp to dynamically modify the fields on a serializer
...
def raise_errors_on_nested_writes(method_name, serializer, validated_data):
    """
    Give explicit errors when usersapp attempt to pass writable nested data.
