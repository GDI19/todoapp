...
class URLPathVersioning(BaseVersioning):
    ...
    urlpatterns = [
        re_path(r'^(?P<version>[v1|v2]+)/usersapp/$', users_list, name='usersapp-list'),
        re_path(r'^(?P<version>[v1|v2]+)/usersapp/(?P<pk>[0-9]+)/$', users_detail, name='usersapp-detail')
    ]
...
class NamespaceVersioning(BaseVersioning):
    ...
    # usersapp/urls.py
    urlpatterns = [
        path('/usersapp/', users_list, name='usersapp-list'),
        path('/usersapp/<int:pk>/', users_detail, name='usersapp-detail')
    ]

    # urls.py
    urlpatterns = [
        path('v1/', include('usersapp.urls', namespace='v1')),
        path('v2/', include('usersapp.urls', namespace='v2'))
    ]
